...
const hero = () => {
    return (
        <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
            ...
            {/* <Spline className="absolute lg:top-0 top-[-20%] bottom-0" scene="https://prod.spline.design/kMsBslKL7YtatPWu/scene.splinecode" /> */}
            {/* <Spline className="absolute lg:top-0 top-[-20%] bottom-0" scene="https://prod.spline.design/S3Ca9ryYBhFbel8X/scene.splinecode" /> */}
            {/* <Spline className="absolute lg:top-0 top-[-20%] bsaottom-0" scene="https://prod.spline.design/SIrLtgA5llI9LQc2/scene.splinecode" /> */}
            <Spline className="absolute lg:top-0 top-[-20%] bottom-0" scene="https://prod.spline.design/SIrLtgA5llI9LQc2/scene.splinecode" />
        </main>
    )
}
